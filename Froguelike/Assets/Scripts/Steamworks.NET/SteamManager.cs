...
#if UNITY_EDITOR_WIN || !(UNITY_STANDALONE_WIN || UNITY_STANDALONE_LINUX || UNITY_STANDALONE_OSX || STEAMWORKS_WIN || STEAMWORKS_LIN_OSX) // having this on makes it not play the game on steam on windows.
