...
namespace Coherence.Generated
{
	...
	public struct GenericScale : ICoherenceComponentData
	{
		...
		public static (GenericScale, uint, uint?) DeserializeArchetypeClassic__char_32_Tongue_4a710caa256322a4aa6bfb19109e4559_GenericScale_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new GenericScale();
			if (bitStream.ReadMask())
